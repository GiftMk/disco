...
export type CreateVideoResponseResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes['CreateVideoResponse'] = ResolversParentTypes['CreateVideoResponse'],
> = ResolversObject<{
...
> = ResolversObject<{
	createVideo?: Resolver<
		Maybe<ResolversTypes['CreateVideoResponse']>,
		ParentType,
		ContextType,
		RequireFields<MutationCreateVideoArgs, 'input'>
	>
	normaliseAudio?: Resolver<
		Maybe<ResolversTypes['NormaliseAudioResponse']>,
		ParentType,
		ContextType,
		RequireFields<MutationNormaliseAudioArgs, 'input'>
	>
}>

export type NormaliseAudioResponseResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes['NormaliseAudioResponse'] = ResolversParentTypes['NormaliseAudioResponse'],
> = ResolversObject<{
	outputFilename?: Resolver<ResolversTypes['String'], ParentType, ContextType>
	__isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}>
...
> = ResolversObject<{
	...
	uploadDetails?: Resolver<
		ResolversTypes['UploadDetails'],
		ParentType,
		ContextType,
		RequireFields<QueryUploadDetailsArgs, 'input'>
	>
}>

export type UploadDetailsResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes['UploadDetails'] = ResolversParentTypes['UploadDetails'],
> = ResolversObject<{
